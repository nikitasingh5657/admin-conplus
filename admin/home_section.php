      ...
      <div class="container-fluid">
        ...
        <form class="form-horizontal" method="post" action="home_section_insert.php">
           ...
           <th>Image view</th> -->
				...
				$res = mysqli_query($conn,"select * from property_info where is_del='no'");
...
<td><img src="<?php echo $image ?>" width="100px" height="100px"></td> -->
         	...
         	<a href="home_section_delete.php?id=<?php echo $row->id ?>" ><div  class="btn btn-danger">Delete</div></a>
					</td>
